...
{
	return megaRequest ? megaRequest->getNodeHandle() : ::mega::UNDEF;
}
...
{
	return megaRequest ? megaRequest->getParentHandle() : ::mega::UNDEF;
}
...
{
	return megaRequest ? megaRequest->getAccess() : ::mega::ACCESS_UNKNOWN;
}
